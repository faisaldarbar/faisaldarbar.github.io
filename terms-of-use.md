...
We use a third-party service Kit (formerly ConvertKit) to manage and deliver emails. Your information is handled according to their [Privacy Policy](https://convertkit.com/privacy){:target="_blank" rel="noopener noreferrer"} and [Terms of Use](https://convertkit.com/terms){:target="_blank" rel="noopener noreferrer"}.

## 3. No Guarantees

We make no guarantees about the accuracy, completeness, or usefulness of the content. Use it at your own risk.
...
These Terms may be updated from time to time. Any changes will be posted on this page with the updated date.
